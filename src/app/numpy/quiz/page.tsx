...
const quiz: QuizType = [
    ...
    {
        question: "What is the correct way to print out the fifth item in an array, assuming the array is stored in the variable 'a'?",
        options: [
            "print(a[5])",
            "print(a[2])",
            "Print(a[4])",
        ...
        answerOption: 2,
        explanation: "Numpy arrays are 0-indexed, meaning you start counting at zero. If you are trying to get the n-th element, you should index to n - 1."
    },
    {
        question: "What is the correct way to print out the number 4 from the array below?",
        ...
        answerOption: 3,
        explanation: "When indexing a 2d array, you first go to the i-th row and then the j-th column. Because 4 is in the first row and the 4th element, you should do [0, 3]. It is also possible to index by doing [0][3]."
    },
    {
        question: "What is the correct way to print out the numbers [2, 3, 4] from the array below?",
        ...
        answerOption: 2,
        explanation: "You can use the ':' operator to select values in between the indexes of i and j. Remember that value at the jth index is not included, but the ith index value is included."
    },
    {
        question: "What is the correct way to print out the seventh item in an array, assuming the array is stored in the variable 'a'?",
        options: [
            "print(a[6])",
            "print(a[7])",
            "print(a[8])",
        ...
        answerOption: 0,
        explanation: "Remember that to access the i-th value, you must index for the i - 1 item because numpy is 0-indexed."
    },
    {
    ...
    {
        question: "What is the correct way to print out the numbers [6, 7, 8, 9] from the array below?",
        ...
        answerOption: 3,
        explanation: "You want to select the values between the 6th value and the 9th value. This work works with the selecting n - 1 using, so indexing 5 to 8. Remember the last index isn't included."
    },
    {
        question: "Which NumPy function is used to find the maximum value in an array?",
        options: [
            `np.max()`,
            `np.maximum()`,
            `np.argmax()`,
