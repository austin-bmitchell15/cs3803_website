...
const quiz: QuizType = [
  {
    question:
      "Which of the following methods in pandas is used to drop rows with missing values from a DataFrame?",
  ...
  {
    question:
      "T/F: Pandas cannot export to Microsoft Excel because its of how different the model is",
    options: ["True", "False"],
    answerOption: 0,
  ...
  {
    question:
      "Which of the following options does not represent a method for obtaining a columnar statistical description of a DataFrame in pandas?",
  ...
  },
  {
    ...
    options: ["Integers", "Floating Points", "Strings", "All of the above"],
    answerOption: 3,
    explanation: `Python is extremely flexible and works with a multitude of different data types.`,
  },
  {
    question:
      "What method is used to create a DataFrame from a dictionary in Pandas?",
    options: [
      "df_from_dict()",
      "create_dataframe()",
      "pd.DataFrame()",
  ...
  {
    question:
      "What method is used to calculate the median of numerical columns in a DataFrame in Pandas?",
  ...
  {
    question:
      "Which method is used to drop missing values from a DataFrame in Pandas?",
  ...
  {
    question:
      "What Pandas function is used to create a pivot table from a DataFrame?",
    options: [
      "pivot_table()",
      "create_pivot()",
      "make_pivot_table()",
