...
const pandasContent: Content = [
    {
        ...
        items: [
            {
                func: "df.head()",
                what_it_does: "Gives the first n rows of the data frame. The default n value is 5."
            },
            {
                func: "df.tail()",
                what_it_does: "Gives the last n rows of the data frame. The default n value is 5 "
            },
            {
                func: "df.sample()",
    ...
    },
    {
        ...
        items: [
            ...
            {
                func: "df.count()",
                what_it_does: "Counts the number of not empty values for each row, or column if you specify the axis parameter as axis='columns', and returns a Series object with the result for each row (or column)."
            },
            {
                func: "df.std()",
    ...
    },
    {
        ...
        items: [
            ...
            {
                func: "df.merge()",
                what_it_does: "Based on specified lefts and right merges two dataframes together"
            },
            {
                func: "df.join()",
                what_it_does: "Inserts columns from another dataframe into an existing one"
            }
        ]
    },
    {
...
export default function PandasTable() {
  return (
    <TablePreview content={pandasContent}/>
  )
}
